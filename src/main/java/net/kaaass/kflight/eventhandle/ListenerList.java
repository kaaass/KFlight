package net.kaaass.kflight.eventhandle;
...
public class ListenerList {
    private static List<ListenerList> allLists = Collections.unmodifiableList(Collections.emptyList());
    ...
    private synchronized static void extendMasterList(ListenerList inst) {
        var list = new ArrayList<>(allLists);
        list.add(inst);
